This program automatically changes the oof sound in the Roblox Player to any sound you want. Simply change the ouch.ogg file to your own file with the same name and extension.
